...
export default function StudentDashboard() {
  ...
  const avgMark  = marks.length > 0
    ...
    : 0;
  const overallGrade = avgMark >= 90 ? 'A+' : avgMark >= 80 ? 'A' :
                       avgMark >= 70 ? 'B'  : avgMark >= 60 ? 'C' : 'D';
        ...
        <div className="grid-2" style={{ marginBottom: '24px' }}>
              ...
              <div key={m.id} style={{ marginBottom: i < arr.length - 1 ? '14px' : 0 }}>
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    background: m.marks >= 80 ? '#16a34a' :
                                m.marks >= 60 ? '#2563eb' : '#d97706',
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            <div style={{
              ...
              <h3 style={{ margin: '0 0 14px', fontSize: '1rem', fontWeight: '700', color: '#1e3a5f' }}>
                ⚡ {t('quickActions')}
              </h3>
                  ...
                  <div style={{ marginBottom: '8px' }}>
                    ...
                    <div style={{
                      ...
                      <div style={{
                        ...
                        background: attPct >= 80 ? '#16a34a' : '#dc2626',
                        borderRadius: '10px'
                      }} />
                    </div>
                  </div>
      ...
      {requests.length > 0 && (
        <div style={{
          ...
          <div className="flex-between" style={{ marginBottom: '14px' }}>
            ...
            <Link to="/student/requests" style={{
              fontSize: '0.8rem', color: '#7c3aed',
              textDecoration: 'none', fontWeight: '600'
            }}>View All →</Link>
          </div>
