...
public class RoomManagerService {
    ...
    public VideoRoom createRoom(String roomName, String creatorId,String creatorName,String callType,int maxParticipants) {
    ...
    public VideoRoom joinRoom(String roomId,String userId,String userName, String role,WebSocketSession session) {
    ...
    public VideoRoom getRoom(String roomId) {return rooms.get(roomId);   }

    public String getUserRoom(String userId) {return userRoomMapping.get(userId);   }
